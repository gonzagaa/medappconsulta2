      ...
      <View style={styles.container}>
       ...
       <ScrollView style={styles.principal}>
            <View style={styles.card}>
                 <View style={styles.contentCard}>
                    <View style={styles.viewFotoMedico}>
                        <Image source={fotoMedico} style={styles.fotoMedico} resizeMode='contain'></Image>
                    </View>
                    ...
                    <View style={styles.detalhesCard}>
                        ...
                        <View style={styles.paragraphys}>
                            <Text style={styles.paragraphy}>Consulta <Text style={styles.paragraphySpanStatus}>Realizada</Text></Text>
                            <Text style={styles.paragraphy}>Data: <Text style={styles.paragraphySpan}>18/12/24</Text></Text>
                            <Text style={styles.paragraphy}>Horario: <Text style={styles.paragraphySpan}>14h30</Text></Text>
                        </View>
                    </View>
                 </View>
            ...
            <View style={styles.card}>
                 <View style={styles.contentCard}>
                    <View style={styles.viewFotoMedico}>
                        <Image source={fotoMedica} style={styles.fotoMedico} resizeMode='contain'></Image>
                    </View>
